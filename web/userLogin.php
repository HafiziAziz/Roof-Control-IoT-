...
<?php
   if (isset($_POST['logmasuk'])) {
       ...
       $query = mysql_query("SELECT * FROM user where username='$username' AND password='$password'", $con);
       ...
       if ($rows==1) {
           ...
           $message1="<div class='alert alert-danger'><strong>Access Denied!</strong><br> Please Check your Username and Password.</div>";
       }
   } else {
       $message1="";
   }
...
<html lang="en">
  <head>
	...
	<link href="css/autocat.css" rel="stylesheet">
   ...
   <img src="images/userLogin.png"  height="150" height="150">
   <br><br><br>
